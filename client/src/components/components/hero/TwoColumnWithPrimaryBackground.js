...
import logoImageSrc from "images/_logo.png";
import serverIllustrationImageSrc from "images/server-illustration-2.svg";

const PrimaryBackgroundContainer = tw.div`-mx-8 px-8 bg-primary-900 text-gray-100`;
const Header = tw(HeaderBase)`max-w-none -mt-8 py-8 -mx-5 px-5`;
...
export default ({
  ...
  const logoLink = (
    <LogoLink href="/">
      <img src={logoImageSrc} alt="Logo"  style={{height: "auto", width: "75px", marginRight: "0px"}}/>
      Sharewin
    </LogoLink>
  );
  const navLinks = [
